<template>
  <div class="features">
    <div class="feature gradient-border">
      ...
      <h4>Discovery</h4>
      <p>
        Get your project discovered by thousands of users through search, our
        home page, discord server, and more ways to come in the future!
      </p>
    </div>
    <div class="feature gradient-border">
      <div class="icon gradient-border">
    ...
    <div class="feature gradient-border">
      ...
      <p>
        Integrate with your build tools through Minotaur for automatic uploads
        right when you release a new version
      </p>
    </div>
    <div class="feature gradient-border">
      <div class="icon gradient-border">
